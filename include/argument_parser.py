...
def args_parser():
    ...
    create_group.add_argument('--large-image', '-li', type=str, help='Set large image.')
    create_group.add_argument('--large-text', '-lt', type=str, help='Set text for large image.')
    create_group.add_argument('--small-image', '-si', type=str, help='Set small image.')
    create_group.add_argument('--small-text', '-st', type=str, help='Set text for small image.')
